-- ============================================================
-- Extend submit_enquiry to persist the per-vehicle road_tax_renewal choice.
-- Identical to 20260629000030 (attachments version) except the
-- enquiry_vehicles INSERT now stores road_tax_renewal.
-- ============================================================
